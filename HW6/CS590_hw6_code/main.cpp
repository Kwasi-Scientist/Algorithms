 ...
 */
	...
	//init d, v_d, pi, v_pi arrays
	int** d = new int* [gr->get_no_of_vertices()];
	//add for loop to init each position
	//this is also done for m_edge
	for (int i =0; i<gr->get_no_of_vertices(); i++){
		d[i] = new int[gr->get_no_of_vertices()];
	}

	int* v_d = new int[gr->get_no_of_vertices()];

	int** pi = new int*[gr->get_no_of_vertices()];
	for (int i =0;i< gr->get_no_of_vertices(); i++){
		pi[i] = new int[gr->get_no_of_vertices()];
	}

	int* v_pi = new int[gr->get_no_of_vertices()];
